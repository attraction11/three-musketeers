;(function (global, factory) {
  ...
  jQuery.extend({
    Deferred: function (func) {
      ...
      var i = 0, resolveValues = slice.call(arguments), length = resolveValues.length,
        ...
        deferred = remaining === 1 ? subordinate : jQuery.Deferred(), updateFunc = function (i, contexts, values) {
  ...
  function defaultPrefilter(elem, props, opts) {
    var prop, value, toggle, tween, hooks, oldfire, display, checkDisplay, anim = this, orig = {}, style = elem.style,
